...
Is similar to the "is compiled?" reporter, but specifically detects if the project is running on turbowarp

## is pholkphorous? {#is-pholkphorous}
Is similar to the "is turbowarp?" reporter, but specifically detects if the project is running on pholkphorous instead of turbowarp
